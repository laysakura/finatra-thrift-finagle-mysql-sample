...
import com.github.laysakura.finatramysqlsample
import com.github.laysakura.finatramysqlsample.annotations.VerboseServiceServer
import com.github.laysakura.finatramysqlsample.idl.{VerboseService, VerboseService$FinagleClient}
...
object VerboseServiceModule extends TwitterModule {
  ...
  def provideVerboseService(
    ...
    @finatramysqlsample.annotations.ClientId clientId: String
